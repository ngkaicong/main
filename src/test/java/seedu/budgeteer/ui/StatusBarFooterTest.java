...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    @Before
    public void setUp() {
        StatusBarFooter statusBarFooter = new StatusBarFooter(STUB_SAVE_LOCATION, entriesBook);
    ...
    public void display() {
        ...
        // after budgeteer book is updated
        guiRobot.interact(() -> entriesBook.addEntry(MALA));
