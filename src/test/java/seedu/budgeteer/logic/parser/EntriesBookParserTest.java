...
public class EntriesBookParserTest {
    @Rule
    public ExpectedException thrown = ExpectedException.none();

    private final EntriesBookParser parser = new EntriesBookParser();

    @Test
    public void parseCommand_add() throws Exception {
        Entry person = new EntryBuilder().build();
        AddCommand command = (AddCommand) parser.parseCommand(EntryUtil.getAddCommand(person));
    ...
    public void parseCommand_edit() throws Exception {
        Entry person = new EntryBuilder().build();
        EditEntryDescriptor descriptor = new EditEntryDescriptorBuilder(person).build();
    ...
    public void parseCommand_filter() throws Exception {
        ...
        FilterCommand command = (FilterCommand) parser.parseCommand(
                FilterCommand.COMMAND_WORD + " " + "n/" + keywords.stream().collect(
                        Collectors.joining(" ")));
