...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() throws Exception {
        ...
        // Execute add command
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + DATE_DESC_AMY + CASHFLOW_DESC_AMY;
     ...
     *      - {@code expectedModel}'s budgeteer book was saved to the storage file.
     */
