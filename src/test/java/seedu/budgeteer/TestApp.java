...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyEntriesBook> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyEntriesBook> initialDataSupplier, Path saveFileLocation) {
        super();
    ...
    /**
     * Returns a defensive copy of the budgeteer book data stored inside the storage file.
     */
