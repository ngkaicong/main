...
import static seedu.address.logic.commands.DisplayCommand.MESSAGE_SUCCESS;
...
public class DisplayCommandTest {
    ...
    private Model emptyModel = new ModelManager(new AddressBookBuilder().build(), new UserPrefs());
    private Model expectedEmptyModel = new ModelManager(new AddressBookBuilder().build(), new UserPrefs());
