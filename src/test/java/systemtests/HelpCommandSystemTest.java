 ...
 */
public class HelpCommandSystemTest extends EntriesBookSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_ENTRY.getOneBased());
        ...
        executeCommand(DeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_ENTRY.getOneBased());
