...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        Entry deletedPerson = removePerson(expectedModel, INDEX_FIRST_PERSON);
    ...
    private Entry removePerson(Model model, Index index) {
        Entry targetPerson = getPerson(model, index);
    ...
    private void assertCommandSuccess(Index toDelete) {
        Model expectedModel = getModel();
        Entry deletedPerson = removePerson(expectedModel, toDelete);
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedPerson);
