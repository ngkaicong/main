...
/**
 * Represents the in-memory model of the budgeteer book data.
 */
public class ModelManager implements Model {
     ...
     */
    public ModelManager(ReadOnlyEntriesBook addressBook, ReadOnlyUserPrefs userPrefs) {
        super();
        requireAllNonNull(addressBook, userPrefs);

        logger.fine("Initializing with budgeteer book: " + addressBook + " and user prefs " + userPrefs);

        versionedAddressBook = new VersionedEntriesBook(addressBook);
    ...
    @Override
    public void setAddressBook(ReadOnlyEntriesBook addressBook) {
