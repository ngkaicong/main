...
// tag::efind[]
=== Easy Searching Of Relevant Data
This command allows users to search through the large amount of entries and find the most relevant information they need.
...
|`* * *` |user |list income details based on tag |see my income belonging in a particular category

|`* * *` |user |list expenses details based on tag |see my expenses belonging in a particular category
...
Use case ends.
[none]
* 1c. The record to be added is a duplicate of an existing record
+
[none]
