...
The command takes in one required argument: `n/`

`n/` (Stock Name): The abbreviated name of the stock
...
image::StockDiagram.png[width="800"]
...
`n/` (Cryptocurrency Name): The abbreviated name of the cryptocurrency
...
The command takes in two required argument: `interest/` and 'years/'

`interest/` (Interest Rate): The interest rate that you want
`years/` (Years): The number of years that this interest should accumulate
