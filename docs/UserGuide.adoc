...
*Screenshot of app displaying expense breakdown when `report insight d/11-11-2018 12-12-2019` is run*
...
* *RECORD DATA* stores all the data of entry the user want to export, there are 4 columns: Name, date, money and tags, the tags names will be separated by ..., for visual benefit.
